                ...
                <div class="col-xs-16 main">
                    ...
                    <div class="recommend-collection">
                        ...
                        <nuxt-link class="collection" to="/collection/123">
                            ...
                            <span name="name">社会热点</span>
                        </nuxt-link>

                        <nuxt-link class="collection" to="/collection/123">
                            <img src="~assets/img/c4.jpg">
                            <span name="name">@IT·互联网</span>
                        </nuxt-link>

                        <nuxt-link class="collection" to="/collection/123">
                            <img src="~assets/img/c1.jpg">
                            <span name="name">旅行·在路上</span>
                        </nuxt-link>
                        ...
                        <ul class="note-list">
                            <li class="have-img">
                                ...
                                <div class="content">
                                    ...
                                    <nuxt-link class="title" to="/p/123">农夫山泉有点甜</nuxt-link>
                                    <div class="abstruct">
                                        忽然觉得最近某个朋友热情起来了。微信里朋友圈开始点赞打招呼了，从不关注我孩子的，居然也问起我的孩子来了。过来喝茶时带着小吃，笑容可掬，春风满面，让人心里暖暖的。就是嘛，我是...
                                    </div>
                                    <div class="meta">
                        ...
                        <div class="recommended-author">
                            <div class="title">
                                ...
                                <span @click="rotatefa++">
                                    ...
                                    <!--<i :class="[rotate?'fa fa-refresh go':'fa fa-refresh qq']"   ></i>-->
                                         <i class="fa fa-refresh"
                                            :style="{transform:'rotate('+360*rotatefa+'deg)'}"></i>
                                    换一批
                                </nuxt-link>
                                </span>
                            ...
                            <ul class="recommended-list">
                                <li>
                                    ...
                                    <a href="#" class="follow" @click="followed">
    ...
    export default {
        ...
        data() {
            return {
                ...
                style:
                    [
                        {icon: 'fa fa-plus', word: '关注', color: '#42c02e'},
                        {icon: 'fa fa-check', word: '已关注', color: '#969696'},
                        {icon: 'fa fa-remove', word: '取消关注', color: '#969696'},
        ...
        methods: {
            // rotatefa() {
            //     // console.log('ssss');
            //     // var a = document.querySelector('.index .aside .recommended-author .title .page-change i ');
            //     // console.log(a)
            //     // current = (current + 90) % 360;
            //     // a.style.transform = 'rotate(' + current + 'deg)';
            ...
            followed() {
                ...
                // console.log(count);
                // var a=document.querySelector('.index .aside .recommended-author .recommended-list li .follow')
                // console.log(a)
                // if(count%2==0){
                //     a.innerHTML='<i class="fa fa-plus"></i> 关注';
                //     a.style.color='#42c02e'
                // }
                // if(count%2==1){
                //     a.innerHTML='<i class="fa fa-check"></i> 已关注';
